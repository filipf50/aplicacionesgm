...
<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
	Modificar medio de descarga
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">

    <h2>Modificar medio de descarga</h2>
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <fieldset>
            ...
            <%: Html.ValidationSummary(true,"Error al guardar el metodo de descarga. Revise los errores y vuelva a intentarlo") %>
