...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>Nuevo requerimiento de calidad</h2>
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <fieldset>
            ...
            <%: Html.ValidationSummary(true,"Error al guardar el nuevo requerimiento de calidad. Revise los errores y vuelva a intentarlo") %>
