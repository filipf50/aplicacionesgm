...
namespace AplicacionesGM_MVC.Areas.Proveedores.Controllers
{
    public class IncidenciasController : Controller
    {
        ...
        {
            ViewData["NoDataFound"] = "No tiene incidencias pendientes.";
            ViewData["Title"] = "Incidencias Pendientes";

            //Cargo los datos de responsables.
            ...
            //Cargo las acciones
            //IEnumerable<aspnet_Acciones> Accion = getIncidencias(sortOrder, sortType, ViewData["Title"].ToString(), formData);
        ...
        public void ExportAccionesListToExcel(string tab)
        {
            ...
            IEnumerable<aspnet_Acciones> acciones = db.aspnet_Acciones;
        ...
        /*private IEnumerable<aspnet_Acciones> getIncidencias(string sortOrder, string sortType, string tab, FormCollection formData)
        {
            ...
            IEnumerable<aspnet_Incidencias> incidencias = db.aspnet_Incidencias;
